...
def prepare_modified(t5: HFEmbedder, clip: HFEmbedder, img: Tensor, prompt: str | list[str], proportion_empty_prompts: float = 0.1, is_train: bool = True, text_emb: list[dict[str, Tensor]] = None) -> dict[str, Tensor]:
...
def prepare_fill_modified(t5: HFEmbedder, clip: HFEmbedder, img: Tensor, prompt: str | list[str], proportion_empty_prompts: float = 0.1, is_train: bool = True, text_emb: list[dict[str, Tensor]] = None, ae: AutoEncoder = None, img_cond_path: str = None, mask_path: str = None) -> dict[str, Tensor]:
    ...
    out_dict = prepare_modified(t5, clip, img, prompt, proportion_empty_prompts, is_train, text_emb)
